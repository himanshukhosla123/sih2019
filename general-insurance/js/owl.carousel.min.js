    ...
    function(t, i, s) {
        var e = {
            ...
            watchVisibility: function() {
                ...
                t.$elem.css({
                    opacity: 0
                }), i.clearInterval(t.autoPlayInterval), i.clearInterval(t.checkVisible), t.checkVisible = i.setInterval(function() {
            ...
            response: function() {
                ...
                e = t(i).width(), o.resizer = function() {
            ...
            play: function() {
                ...
                i.clearInterval(t.autoPlayInterval), t.autoPlayInterval = i.setInterval(function() {
                    t.next(!0)
                }, t.options.autoPlay)
            },
            ...
            gestures: function() {
                ...
                r.isCssFinish = !0, r.$elem.on(r.ev_types.start, ".owl-wrapper", function(s) {
                    var n;
                    if (3 === (s = s.originalEvent || s || i.event).which) return !1;
            ...
            lazyPreload: function(t, s) {
                function e() {
                    t.data("owl-loaded", "loaded").removeClass("loading"), s.removeAttr("data-src"), "fade" === n.options.lazyEffect ? s.fadeIn(400) : s.show(), "function" == typeof n.options.afterLazyLoad && n.options.afterLazyLoad.apply(this, [n.$elem])
                }
                var o, n = this,
                    a = 0;
                "DIV" === s.prop("tagName") ? (s.css("background-image", "url(" + s.data("src") + ")"), o = !0) : s[0].src = s.data("src"),
                    function t() {
                        a += 1, n.completeImg(s.get(0)) || !0 === o ? e() : 100 >= a ? i.setTimeout(t, 100) : e()
                    }()
            },
            autoHeight: function() {
                function s() {
                    var s = t(o.$owlItems[o.currentItem]).height();
                    o.wrapperOuter.css("height", s + "px"), o.wrapperOuter.hasClass("autoHeight") || i.setTimeout(function() {
                        o.wrapperOuter.addClass("autoHeight")
                    }, 0)
                }
                var e, o = this,
                    n = t(o.$owlItems[o.currentItem]).find("img");
                void 0 !== n.get(0) ? (e = 0, function t() {
                    e += 1, o.completeImg(n.get(0)) ? s() : 100 >= e ? i.setTimeout(t, 100) : o.wrapperOuter.css("height", "")
                }()) : s()
            },
            ...
            addItem: function(t, i) {
                var s;
                return !!t && (0 === this.$elem.children().length ? (this.$elem.append(t), this.setVars(), !1) : (this.unWrap(), (s = void 0 === i || -1 === i ? -1 : i) >= this.$userItems.length || -1 === s ? this.$userItems.eq(-1).after(t) : this.$userItems.eq(s).before(t), void this.setVars()))
            },
