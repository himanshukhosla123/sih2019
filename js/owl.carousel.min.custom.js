! function(t, s, e, o) {
    function n(s, i) {
        s.owlCarousel = {
            ...
            released: "03.05.2014"
        }, this.options = t.extend({}, h, i), this._options = t.extend({}, h, i), this.dom = t.extend({}, r), this.width = t.extend({}, d), this.num = t.extend({}, p), this.pos = t.extend({}, l), this.drag = t.extend({}, m), this.speed = t.extend({}, u), this.state = t.extend({}, c), this.e = t.extend({}, g), this.dom.el = s, this.dom.$el = t(s), this.init()
    }
    ...
    n.prototype.init = function() {
    ...
    }, n.prototype.sortOptions = function() {
    ...
    }, n.prototype.createItem = function() {
        var t = e.createElement(this.options.itemElement);
        return t.className = this.options.itemClass, t
    }, n.prototype.fetchContent = function(s) {
        this.dom.$content = s ? s instanceof jQuery ? s : t(s) : this.options.nestedItemSelector ? this.dom.$el.find("." + this.options.nestedItemSelector).not(".owl-stage-outer") : this.dom.$el.children().not(".owl-stage-outer"), this.num.oItems = this.dom.$content.length, 0 !== this.num.oItems && this.initStructure()
    }, n.prototype.initStructure = function() {
        this.state.lazyContent = !!(this.options.lazyContent && this.num.oItems >= 3 * this.options.items), this.state.lazyContent ? (this.pos.currentAbs = this.options.items, this.dom.$content.remove()) : this.createNormalStructure()
    ...
    }, n.prototype.createCustomStructure = function(s) {
        for (var i = 0; s > i; i++) {
            var e = this.createItem(),
                o = t(e);
            this.setData(o, !1), this.dom.$stage.append(o)
        }
    }, n.prototype.createLazyContentStructure = function(t) {
    ...
    }, n.prototype.fillItem = function(s, i) {
        var e = this.createItem(),
            o = s[i] || s,
            n = this.traversContent(o);
        return this.setData(e, !1, n), t(e).append(o)
    }, n.prototype.traversContent = function(s) {
        var i, e, o = t(s);
    ...
    }, n.prototype.setData = function(s, i, e) {
        var o, n;
        e && (o = e.dot, n = e.hash);
        var a = {
            index: !1,
    ...
    }, n.prototype.checkVideoLinks = function() {
        if (!this.options.video) return !1;
        for (var t, s, i = 0; i < this.num.items; i++) s = this.dom.$items.eq(i), s.data("owl-item").hasVideo || (t = s.find(".owl-video"), t.length && (this.state.hasVideos = !0, this.dom.$items.eq(i).data("owl-item").hasVideo = !0, t.css("display", "none"), this.getVideoInfo(t, s)))
    }, n.prototype.getVideoInfo = function(t, s) {
    ...
    }, n.prototype.createVideoTn = function(s, i) {
        function e(t) {
            n = '<div class="owl-video-play-icon"></div>', o = d.options.lazyLoad ? '<div class="owl-video-tn ' + r + '" ' + h + '="' + t + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background-image:url(' + t + ')"></div>', s.after(o), s.after(n)
        }
        var o, n, a = s.find("img"),
            h = "src",
            r = "",
            d = this;
        if (this.options.lazyLoad && (h = "data-src", r = "owl-lazy"), a.length) return e(a.attr(h)), a.remove(), !1;
        "youtube" === i.type ? e("http://img.youtube.com/vi/" + i.id + "/hqdefault.jpg") : "vimeo" === i.type && t.ajax({
            type: "GET",
            url: "http://vimeo.com/api/v2/video/" + i.id + ".json",
            jsonp: "callback",
            dataType: "jsonp",
            success: function(t) {
                e(t[0].thumbnail_large), d.options.loop && d.updateItemState()
            }
        })
    ...
    }, n.prototype.playVideo = function(s) {
        ...
        var s, i, e, o = this.options.items,
            n = this.num.oItems - 1;
        for (this.options.stagePadding && 1 === this.options.items && (o += 1), this.num.cItems = 2 * o, e = 0; o > e; e++) {
        ...
        this.width.stage = Math.abs(this.options.autoWidth ? this.options.center ? o : i : o);
        var r = this.num.oItems + this.num.cItems;
        for (s = 0; r > s; s++) this.dom.$items.eq(s).data("owl-item").indexAbs = s;
        this.setMinMax(), this.setSizes()
    }, n.prototype.setMinMax = function() {
        ...
        for (this.num.active = 0, stageX = this.pos.stage, view = this.options.rtl ? this.width.view : -this.width.view, s = 0; s < this.num.items; s++) i = this.dom.$items.eq(s), e = i.data("owl-item").posLeft, o = i.data("owl-item").width, n = this.options.rtl ? e + o : e - o, (this.op(e, "<=", stageX) && this.op(e, ">", stageX + view) || this.op(n, "<", stageX) && this.op(n, ">", stageX + view)) && (this.num.active++, this.options.freeDrag && !a && (a = !0, this.pos.current = i.data("owl-item").index, this.pos.currentAbs = i.data("owl-item").indexAbs), i.data("owl-item").active = !0, i.data("owl-item").current = !0, i.addClass(this.options.activeClass), this.options.lazyLoad || (i.data("owl-item").loaded = !0), this.options.loop && (this.options.lazyLoad || this.options.center) && this.updateClonedItemsState(i.data("owl-item").index))
    }, n.prototype.updateClonedItemsState = function(t) {
        var s, i, e;
        for (this.options.center && (s = this.dom.$items.eq(this.pos.currentAbs).data("owl-item").index), e = 0; e < this.num.items; e++) i = this.dom.$items.eq(e), i.data("owl-item").index === t && (i.data("owl-item").current = !0, i.data("owl-item").index === s && i.addClass(this.options.centerClass))
    }, n.prototype.updateLazyPosition = function() {
    ...
    }, n.prototype.updateLazyContent = function(t) {
        var s, i, e, n, a, h, r;
        if (this.pos.lcCurrent === o && (this.pos.lcCurrent = 0, this.pos.current = this.pos.currentAbs = this.options.items), t || this.updateLazyPosition(), !1 !== this.state.lcDirection)
            for (s = 0; s < this.pos.lcMovedBy; s++) "right" === this.state.lcDirection && (e = this.dom.$stage.find(".owl-item").eq(0), e.appendTo(this.dom.$stage)), "left" === this.state.lcDirection && (e = this.dom.$stage.find(".owl-item").eq(-1), e.prependTo(this.dom.$stage)), e.data("owl-item").active = !1;
        for (this.dom.$items = this.dom.$stage.find(".owl-item"), i = 0; i < this.num.items; i++) this.dom.$items.eq(i).removeClass(this.options.centerClass), n = this.pos.lcCurrent + i - this.options.items, n >= this.dom.$content.length && (n -= this.dom.$content.length), n < -this.dom.$content.length && (n += this.dom.$content.length), a = this.dom.$content.eq(n), h = this.dom.$items.eq(i), r = h.data("owl-item"), (!1 === r.active || 0 !== this.pos.goToLazyContent || !0 === t) && (h.empty(), h.append(a.clone(!0, !0)), r.active = !0, r.current = !0, r.loaded = !this.options.lazyLoad);
        ...
        this.e._onDragStart = function(t) {
            ...
            return !t(s.target).hasClass("disabled") && (s.preventDefault(), void this.next())
        }.bind(this), this.e._navPrev = function(s) {
            return !t(s.target).hasClass("disabled") && (s.preventDefault(), void this.prev())
        }.bind(this)
    }, n.prototype.responsiveTimer = function() {
        return this.windowWidth() !== this.width.prevWindow && (s.clearInterval(this.e._autoplay), s.clearTimeout(this.resizeTimer), this.resizeTimer = s.setTimeout(this.e._responsiveCall, this.options.responsiveRefreshRate), void(this.width.prevWindow = this.windowWidth()))
    }, n.prototype.internalEvents = function() {
        var t = "ontouchstart" in s || !!navigator.msMaxTouchPoints,
            i = s.navigator.msPointerEnabled;
        this.dragType = t && !i ? ["touchstart", "touchmove", "touchend", "touchcancel"] : t && i ? ["MSPointerDown", "MSPointerMove", "MSPointerUp", "MSPointerCancel"] : ["mousedown", "mousemove", "mouseup"], (t || i) && this.options.touchDrag ? this.on(e, this.dragType[3], this.e._onDragEnd) : (this.dom.$stage.on("dragstart", function() {
            return !1
        }), this.options.mouseDrag ? this.dom.stage.onselectstart = function() {
            return !1
        } : this.dom.$el.addClass("owl-text-select-on")), this.dom.$stage.on(this.dragType[2], ".owl-video-play-icon", this.e._playVideo), this.options.URLhashListener && this.on(s, "hashchange", this.e._goToHash, !1), this.options.autoplayHoverPause && (this.dom.$stage.on("mouseover", this.e._pause), this.dom.$stage.on("mouseleave", this.e._ap)), this.transitionEndVendor && this.on(this.dom.stage, this.transitionEndVendor, this.e._transitionEnd, !1), !1 !== this.options.responsive && this.on(s, "resize", this.e._resizer, !1), this.updateEvents()
    }, n.prototype.updateEvents = function() {
        ...
        if (this.state.isTouch) {
            ...
            (Math.abs(this.drag.distance) > 3 || t > 300) && this.removeClick(this.drag.targetEl);
            var s = this.closest(this.drag.updatedX);
            this.setSpeed(this.options.dragEndSpeed, !1, !0), this.animStage(this.pos.items[s]), this.options.pullDrag || this.drag.updatedX !== this.pos.items[s] || this.transitionEnd(), this.drag.distance = 0, this.off(e, this.dragType[1], this.e._onDragMove), this.off(e, this.dragType[2], this.e._onDragEnd)
        }
    ...
    }, n.prototype.animStage = function(t) {
    ...
    }, n.prototype.jumpTo = function(t, s) {
    ...
    }, n.prototype.goTo = function(t, s) {
        return (!this.state.lazyContent || !this.state.inMotion) && (this.updatePosition(t), this.state.animate && (s = 0), this.setSpeed(s, this.pos.currentAbs), this.state.animate && this.animate(), void this.animStage(this.pos.items[this.pos.currentAbs]))
        ...
        var s = t || this.options.navSpeed;
        this.options.loop && !this.state.lazyContent ? this.goToLoop(-this.options.slideBy, s) : this.goTo(this.pos.current - this.options.slideBy, s)
    }, n.prototype.goToLoop = function(t, i) {
        var e = this.pos.currentAbs,
            o = this.pos.currentAbs,
            n = this.pos.currentAbs + t,
            a = 0 > o - n;
        this.state.revert = !0, 1 > n && !1 === a ? (this.state.bypass = !0, e = this.num.items - (this.options.items - o) - this.options.items, this.jumpTo(e, !0)) : n >= this.num.items - this.options.items && !0 === a && (this.state.bypass = !0, e = o - this.num.oItems, this.jumpTo(e, !0)), s.clearTimeout(this.e._goToLoop), this.e._goToLoop = s.setTimeout(function() {
            this.state.bypass = !1, this.goTo(e + t, i), this.state.revert = !1
        }.bind(this), 30)
    }, n.prototype.initPosition = function(t) {
    ...
    }, n.prototype.windowWidth = function() {
    ...
    }, n.prototype.createNavigation = function(s) {
    ...
    }, n.prototype.createDots = function(s) {
        var i = e.createElement("div");
    ...
    }, n.prototype.rebuildDots = function() {
    ...
    }, n.prototype.addItem = function(s, i) {
    ...
    }, n.prototype.addCustomEvents = function() {
    ...
    }, n.prototype.storeInfo = function() {
    ...
    }, n.prototype.autoHeight = function(t) {
    ...
    }, n.prototype.preload = function(s, i) {
        var e = this;
        s.each(function(s, o) {
            var n = t(o),
                a = new Image;
        ...
        return this.each(function() {
            t(this).data("owlCarousel") || t(this).data("owlCarousel", new n(this, s))
        })
    }
